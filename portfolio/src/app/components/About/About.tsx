        ...
        <div className="flex flex-col items-center justify-center text-lg md:flex-row">
          <div className="mt-5 flex flex-col items-center justify-center space-y-4 text-left md:mt-0 md:w-2/3 md:pl-10 md:text-justify">
            <p className="text-gray-700 dark:text-gray-300">
              Formé parte del equipo de <strong>RkiveAI</strong>, una plataforma impulsada por
            ...
            <div className="text-gray-700 dark:text-gray-300">
              ...
              <ul className="ml-5 mt-2 list-disc">
                ...
                <li>
                  Desarrollo frontend (Next.js y React Native/Expo): funcionalidades end-to-end de cero a producción.
                </li>
                <li>
                  Implementación y evolución de pagos con Stripe (Checkout, Elements y webhooks) para suscripciones.
                </li>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Vengo de un background en electrónica y microinformática, y desde pequeño me encanta este mundo
              relacionado con la tecnología. En 2023 redirigí mi carrera hacia la programación y desde entonces me
              motiva crear productos que aporten valor real y mejoren la experiencia de los usuarios.
            </p>

            <p className="font-semibold text-gray-700 dark:text-gray-300">
              Actualmente me encuentro en búsqueda activa de nuevas oportunidades laborales como Fullstack Developer,
              donde pueda seguir aportando mis conocimientos, aprender y crecer profesionalmente.
            </p>
          </div>
        </div>
      </div>
